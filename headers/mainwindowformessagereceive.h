...
signals:
    ...
    void signalSendHorizontalRotationAxis(float x1, float y1, float z1, float x2, float y2, float z2);
    void signalSendVerticalRotationAxis(float x1, float y1, float z1, float x2, float y2, float z2);
public slots:
